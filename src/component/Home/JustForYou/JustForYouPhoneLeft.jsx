...
import { Box, Flex, Image, Skeleton, Stack, Text, VStack } from '@chakra-ui/react'
import React from 'react'
import { Link } from 'react-router-dom'
import loadingimg from '../../../assets/E-box_Logo-removebg-preview.png'
const JustForYouPhoneLeftCard = ({product, loading}) => {
    // React.useEffect(() => {
  ...
  return (
        <>
        <Flex flexWrap={'wrap'}>
             <Flex  _hover={{shadow:{base:'xl', md:'2xl'}}} bg={'white'} w={ {base:'100%', sm:'49.5%',md:'24.5%', lg:'16.5%'}} borderRadius={5} overflow={'hidden'}className='cardshop'>
                        <VStack spacing={3}  as={Link} w={'100%'} to={`/ditals-product/${product._id}/${product.productname}`}   pb={3} overflow={'hidden'} borderRadius={2} alignItems={'start'}>
                        {
...
export default JustForYouPhoneLeftCard
