...
const LowPricephoneLeftCard = ({product, index}) => {
                ...
                <VStack gap={1} alignItems={'start'} w={'full'}>
                        <VStack   as={Link} to={`/ditals-product/${product?._id}/${product?.productname}`}    overflow={'hidden'} borderRadius={2} alignItems={'start'}>
                            ...
                            <Box>
                                ...
                                <VStack gap={0} w={'full'} alignItems={'start'} spacing={1} >
                                {
                        ...
                        <Flex w={'full'} justifyContent={'center'} alignItems={'center'}>
                                    <Button borderRadius={0} w={'full'}  bg={'blue.500'} color={'whiteAlpha.800'} fontWeight={500} _hover={{bg:'blue.500'}} variant={'outline'} size={'sm'} h={8}>Shop now</Button>
                                </Flex>
                        </VStack>
                    </Flex>
        </>
...
export default LowPricephoneLeftCard
