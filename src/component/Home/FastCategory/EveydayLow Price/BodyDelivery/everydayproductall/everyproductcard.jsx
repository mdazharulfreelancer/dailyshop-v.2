             ...
             <Flex  bg={'white'}  w={{base:'48.6%', sm:'32.5%',md:'24.5%', lg:'16.5%'}}   className='cardshop'>
                        <VStack     as={Link} to={'/ditals-product/asdsad'}   pb={3} overflow={'hidden'} borderRadius={2} alignItems={'start'}>
                            <Box onMouseOver={()=>setIsHovering(true)} onMouseLeave={()=>setIsHovering(false)} pos={'relative'} w={'full'} h={{base:'172px',sm:'205px'}}>
                                <Image zIndex={2} w={'full'} h={'full'} _hover={{transform:'scale(1.02)', backdropFilter:'contrast(40%)', background:'gray.500'}} transition={'0.5s'} src={'https://static-01.daraz.com.bd/p/97f65f31a176f347c68c37de9b5cb97e.jpg_300x0q75.webp'} />
...
export default EverydayprocutCard
