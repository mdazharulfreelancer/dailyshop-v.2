...
const NewProductLeftCard = ({product, index}) => {
             ...
             <Flex   bg={'white'}borderRadius={6} overflow={'hidden'}  w={{base:'100%', sm:'32.5%',md:'24.5%', lg:'16.5%'}}   className='cardshop'>
                <VStack  alignItems={'start'} w={'full'} gap={1}>
                        ...
                        <Flex w={'full'} justifyContent={'center'} alignItems={'center'}>
                                    <Button w={'full'}  bg={'#148a8b'} color={'whiteAlpha.800'}borderRadius={0}  fontWeight={500} _hover={{bg:'blue.500'}} variant={'outline'} size={'sm'} h={8}>Shop now</Button>
                                </Flex>
                    </VStack>
                    </Flex>
        </>
...
export default NewProductLeftCard
