             ...
             <Flex  bg={'white'} w={{base:'49.5%', sm:'32.5%',md:'24.5%', lg:'16.5%'}}   className='cardshop'>
                        <VStack     as={Link} to={'/ditals-product/asdsad'}   pb={3} overflow={'hidden'} borderRadius={2} alignItems={'start'}>
                            <Box onMouseOver={()=>setIsHovering(true)} onMouseLeave={()=>setIsHovering(false)} pos={'relative'} w={'full'}>
                                <Image zIndex={2} _hover={{transform:'scale(1.02)', backdropFilter:'contrast(40%)', background:'gray.500'}} transition={'0.5s'} w={'full'} src={'https://static-01.daraz.com.bd/p/d15ad28238f483c042d1845e96ff0cd5.jpg_300x0q75.webp'} />
